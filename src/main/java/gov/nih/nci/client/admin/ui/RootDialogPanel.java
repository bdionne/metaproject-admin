...
public class RootDialogPanel extends JPanel implements VerifiedInputEditor {
    ...
    private void initUi() {
        ...
        holderPanel.add(rootLbl, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.BASELINE_TRAILING, GridBagConstraints.NONE, new Insets(20, 2, 2, 2), 0, 0));
        holderPanel.add(root, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.BASELINE_LEADING, GridBagConstraints.HORIZONTAL, new Insets(0, 2, 0, 2), 0, 0));
    }
    ...
    public static boolean showDialog(OWLEditorKit editorKit, String root) {
        ...
        int response = new UIHelper(editorKit).showValidatingDialog("Edit Root '" + root + "'", panel, null);
